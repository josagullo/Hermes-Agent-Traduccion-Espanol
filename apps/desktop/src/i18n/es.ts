...
export const es: Translations = {
  ...
  "settings": {
    ...
    "appearance": {
      ...
      "terminalFontDesc": "Choose an installed font for Desktop terminals. Nerd Fonts render Powerlevel10k and shell icons; leave blank to use bundled JetBrains Mono.",
    ...
    "config": {
      ...
      "attachmentSizeDesc": "How big a local file Desktop will load for previews and image attach, in MB. Default is 16. Remote non-image attach uses a separate 256 MB cap. Setting this very high loads the whole file into memory and can freeze or crash the app.",
      "attachmentSizeUnit": "MB",
      "attachmentSizeLabel": "Max preview / image load size in megabytes",
    },
    "quickEntry": {
      "enabledTitle": "Quick Entry",
      "enabledDesc": "Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Hermes.",
    ...
    "gateway": {
      ...
      "intro": "Local by default. Use remote when this app should drive a Hermes backend elsewhere. Per-profile overrides below.",
      "appliesTo": "Applies to",
      "allProfiles": "Perfiles",
      "defaultConnection": "Default connection for every profile that has no override of its own.",
      "profileConnection": (profile) => `Connection used only when \u201C${profile}\u201D is the active profile. Choose Use default gateway to remove its override.`,
    ...
    "sessions": {
      ...
      "autoArchiveDesc": "Automatically archive chats you haven't touched in a while. Pinned chats are never archived, and nothing is deleted — archived chats just move here.",
  ...
  "commandCenter": {
    ...
    "nav": {
      ...
      "skills": {
        "title": "Sesiones",
        "detail": "Skills, tools, and MCP servers",
      },
      "messaging": {
        "title": "Sesiones",
  ...
  "webhooks": {
    ...
    "disabledBody": "Webhooks are their own gateway platform. Enable them here to accept incoming HTTP events; chat channels are only needed when a subscription delivers to Telegram, Discord, Slack, or another channel.",
...
Leave blank to keep the ${mode} default.`,
  ...
  "composer": {
    ...
    "newSessionPlaceholders": ["What are we building?", "Give Hermes a task", "What's on your mind?", "Describe what you need", "What should we tackle?", "Ask anything", "Start with a goal"],
    "followUpPlaceholders": ["Send a follow-up", "Add more context", "Refine the request", "What's next?", "Keep it going", "Push it further", "Adjust or continue"],
  ...
  "install": {
    ...
    "setupChoiceDesc": "Connect this app to a Hermes gateway you already run, or install Hermes locally on this computer.",
  ...
  "assistant": {
    "thread": {
      ...
      "resumeWhenBackgroundDone": (count) => count === 1 ? "Will resume when the background task finishes" : `Will resume when ${count} background tasks finish`,
      "thinking": "Thinking",
      "thought": "Thought",
